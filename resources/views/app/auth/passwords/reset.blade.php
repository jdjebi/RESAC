...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card resac-account-card-support resac-linkedin-shadow p-5">
                <div class="card-header">Réinitilisationn du mot de passe</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('app.reinit.password') }}">
                        @csrf
