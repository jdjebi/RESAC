<div v-if="post" class="border rounded shadow-sm bg-white">
    <div class="p-3 border-bottom">
        ...
        <div v-if="post.validate_status == 1">
        ...
        <div v-else>
            ...
            <button v-bind:disabled="is_post_manager_operation" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Certifier</button>
        </div>
    </div>
    <div class="p-3 border-bottom">
        <div>
            <div class="h5 mb-3">Publication</div>
            <a class="btn btn-warning btn-sm" href="#"><i class="fa fa-ban"></i> Bloquer la publication</a>
            <a class="btn btn-light btn-sm" href="#"><i class="fas fa-archive"></i> Retirer la publication</a>
        </div>
    </div>
    <div class="p-3">
        <div class="h5 mb-3">Zone dangereuse</div>
        <a class="btn btn-danger btn-sm" href="#"><i class="fa fa-trash"></i> Supprimer la publication</a>
    </div>
</div>